...
function emptyDb(): Database {
  ...
  return {
    ...
    platform_settings: {
      ...
      price_cents: DEFAULT_PRICES.priceCents,
      lawyer_cut_cents: DEFAULT_PRICES.lawyerCutCents,
      platform_cut_cents: DEFAULT_PRICES.platformCutCents,
...
function normalizeDb(db: Database): Database {
  ...
  for (const r of db.consultation_requests ?? []) {
    ...
    if (any.client_rating_of_lawyer === undefined) any.client_rating_of_lawyer = null;
    if (any.client_rating_comment === undefined) any.client_rating_comment = null;
    if (any.lawyer_rating_of_client === undefined) any.lawyer_rating_of_client = null;
    if (any.lawyer_rating_comment === undefined) any.lawyer_rating_comment = null;
