    ...
    <Shell title="Consulta em andamento" backHref={`/standby/${requestId}`}>
      <Card>
        ...
        <p className="text-sm text-slate-600">
          Timer de 60 minutos. Ao concluir (completed), o advogado recebe o
          corte via Pix — nunca antes. Assunto/resumo já liberado após o accept.
        </p>
        <StubNote>
          Stub LiveKit (<code>lib/livekit.ts</code>). Encerrar sessão →
          completed → <code>enqueueLawyerPayout</code>.
        </StubNote>
      </Card>
    </Shell>
  );
